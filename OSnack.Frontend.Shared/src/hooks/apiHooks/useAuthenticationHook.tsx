...
import { User, ProblemDetails, LoginInfo, ExternalLoginInfo } from "../../_core/apiModels";
...
export const useSilentOfficialAuthentication = async (): Promise<User> =>{
        let url_ = API_URL + "/Authentication/Get/SilentOfficial";
        url_ = url_.replace(/[?&]$/, "");
...
export const useSilentSecretAuthentication = async (): Promise<User> =>{
        let url_ = API_URL + "/Authentication/Get/SilentSecret";
        url_ = url_.replace(/[?&]$/, "");
