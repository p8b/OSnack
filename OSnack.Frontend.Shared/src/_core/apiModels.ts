...
export enum DisputeFilterTypes {
...
export const DisputeFilterTypesList=[
{Id:0,Name:"None".replace(/([A-Z])/g, ' $1').trim(),Value:DisputeFilterTypes.None},
{Id:1,Name:"Open".replace(/([A-Z])/g, ' $1').trim(),Value:DisputeFilterTypes.Open},
{Id:2,Name:"Close".replace(/([A-Z])/g, ' $1').trim(),Value:DisputeFilterTypes.Close},
{Id:3,Name:"OpenAndClose".replace(/([A-Z])/g, ' $1').trim(),Value:DisputeFilterTypes.OpenAndClose},
]
export class Role {
    id?: number = 0;
    name!: string;
...
export class UserAndIsAuthenticated {
    user?: User | undefined;
...
export class OrderListAndAvailableTypesAndTotalCountAndDisputeFilterType extends OrderListAndAvailableTypesAndTotalCount {
