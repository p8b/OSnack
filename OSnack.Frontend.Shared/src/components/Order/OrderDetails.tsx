...
const OrderDetails = (props: IProps) => {
   ...
   return (
      <div className="row pm-0 mt-1">
         ...
         <div className="col-12 col-md-6 col-lg-5">
            <div className=" pos-sticky t-0">
               ...
               <div className="row pm-0 ">
                  ...
                  <div className="col-5 p-0 small-text">{props.order.payment.reference}</div>
                  <div className="col-7 pm-0 small-text text-gray">Payment date :</div>
                  <div className="col-5 p-0 small-text">{new Date(props.order.date!).ToShortDate()}</div>
                  <div className="col-7 pm-0 small-text text-gray">Subtotal :</div>
                  <div className="col-5 small-text p-0">£{props.order.totalItemPrice}</div>
                  <div className="col-7 pm-0  small-text text-gray">Shippment Price:</div>
                  <div className="col-5 small-text p-0">{props.order.shippingPrice === 0 ? "Free" : `£${props.order.shippingPrice}`}</div>
                  {props.order.totalDiscount > 0 &&
                     <>
                        <div className="col-7 p-0 small-text text-gray">Discount Price:</div>
                        <div className="col-5 small-text p-0">£{props.order.totalDiscount}</div>
                     </>
                  }
         ...
         {/***** OrderItem ****/}
         <div className="col-12 col-md-6 col-lg-7 mt-3 mt-md-1">
            <div className="row px-3">
               ...
               {props.order.orderItems?.map(orderItem =>
                  <div key={orderItem.productId} className="row pm-0">
                     ...
                     <div className="row col-10 pm-0 mb-3 ">
