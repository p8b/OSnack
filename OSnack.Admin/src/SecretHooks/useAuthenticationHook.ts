...
export type IReturnUseSilentSecretAuthentication={ data:User , status?: number;};
export const useSilentSecretAuthentication = async (): Promise<IReturnUseSilentSecretAuthentication> =>{
