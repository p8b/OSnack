...
export const useCreateAddress = async (newAddress = new Address()) => {
   let alert = new AlertObj([], AlertTypes.Error);
   try {
      const response = await httpCaller.post(`${API_URL}/Address/Post`, newAddress);
   ...
   return { alert, address: newAddress };
};